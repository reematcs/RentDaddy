            ...
            <Sider style={siderStyle}>
                ...
                <div className="demo-logo-vertical d-flex flex-column align-items-center justify-content-center my-5">
                    ...
                    <Link to="/">
                        ...
                        <img src="/logo.png" alt="Rent Daddy Logo" className='logo-image' width={64} height={64} style={{
                            display: 'block',
                            margin: '0 auto'
                        }} />
                    </Link>
                ...
                <div className='avatar-container d-flex flex-column position-absolute bottom-0' style={{ width: "100%" }}>
                    ...
                    <Link to="/authentication/login">
                        <div className='d-flex flex-row align-items-center justify-content-center'>
                            ...
                            <Avatar className='avatar-icon' size={64} icon={<UserOutlined />} />
                        </div>
                    </Link>
